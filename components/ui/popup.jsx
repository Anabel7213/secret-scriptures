...
export default function Popup({title, desc, onClose, onCancel, onConfirm}) {
    return (
        <>
        <div className="shadow-lg w-full md:max-w-[500px] backdrop-blur-sm text-brown md:w-fit gap-4 self-center mx-auto inset-0 absolute border border-brown rounded-[16px] p-6 bg-bg md:p-8 flex flex-col justify-center">
